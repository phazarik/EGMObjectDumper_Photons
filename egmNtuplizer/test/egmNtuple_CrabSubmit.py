...
#    submit(config)
    ...
    config.General.requestName = 'job_GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_Run3Summer19_2021'
    ...
    config.General.requestName = 'job_GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_Run3Summer19_2021'
